...
/** JTextPaneAppender - classe auxiliar de log
 *
...
public class JTextPaneAppender extends AppenderSkeleton {
    ...
    public JTextPaneAppender(JTextPane j) {
        ...
        StyleConstants.setForeground(_styleNormal, Color.BLUE);

        _styleBlue = doc.addStyle("blue", null);
        StyleConstants.setForeground(_styleBlue, Color.BLUE);

        _styleYellow = doc.addStyle("yellow", null);
        StyleConstants.setForeground(_styleYellow, Color.YELLOW);
    ...
    /** append - Método que recebe um evento e gera log
     *
     * @param event
     */
    @Override
    ...
    /** close - Método autogerado para fechamento
     *
     */
    @Override
    public void close() {
